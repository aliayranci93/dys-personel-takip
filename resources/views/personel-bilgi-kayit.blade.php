                                        ...
                                        <div class="tab-content" id="myTabContent">
                                            <div class="tab-pane fade show active" id="tabProfile" role="tabpanel" aria-labelledby="tab-profile">
                                                <div class="row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input id="sira_no" type="text" class="form-control" name="sira" placeholder="Sıra No" required>
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label for="kimlik">Kimlik Numarası</label>
                                                        <input id="kimlik_no" type="text" class="form-control" name="kimlik" placeholder="Kimlik Numaranız" required>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="form-group col-md-6">
                                                        <label for="gender">Medeni Hali</label>
                                                        <select id="medeni_hali"class="form-select" name="gender" required>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input id="gorev_baslama_tarihi" class="form-control" type="date" name="görevtarih" required>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input id="cep_tel" class="form-control" type="cep_tel" name="telephone" placeholder="Cep Telefonu" required>
                                                </div>
                                            ...
                                            <div class="tab-pane fade" id="tabBilling" role="tabpanel" aria-labelledby="tab-billing">
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label class="radio-inline" for="sozlesmeli_olup_olmadigi-0">Sözleşmeli Mi</label>
                                                          ...
                                                          <label class="radio-inline" for="sozlesmeli_olup_olmadigi-1">
                                                            <input type="radio" name="sozlesmeli_olup_olmadigi" id="sozlesmeli_olup_olmadigi-1" value="" checked="checked">
                                                            Hayır
                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input id="kurum_sicil_no" type="number" class="form-control" name="kurum_sicil_no" placeholder="Kurum Sicil No" required>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select  id="kadro_derecesi" name="kadro-derecesi" class="form-select" required>
