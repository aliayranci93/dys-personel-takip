      ...
      <div class="body-inner">
         ...
         <header id="header" data-fullwidth="true">
            <div class="header-inner">
               <div class="container">
                  <!--Logo-->
                  <div id="logo"> <a href="index.html"><span class="logo-default">Ticaret Bakanlığı Takip Sistemi</span><span class="logo-dark">TİCARET BAKANLIĞ<I></I></span></a> </div>
                  <!--End: Logo-->
                  <!-- Search -->
                  <div id="search">
                           ...
                           <ul>
                              ...
                              <li class="dropdown">
                                 ...
                                 <ul class="dropdown-menu">
                                    ...
                                    <li class="dropdown-submenu">
                                       <a href="#">Main Menu<span class="badge bg-danger">NEW</span></a>
                                       <ul class="dropdown-menu">
                                    ...
                                    <li class="dropdown-submenu">
                                       <a href="#">Page Menu<span class="badge bg-danger">NEW</span></a>
                                       <ul class="dropdown-menu">
                                    ...
                                    <li class="mega-menu-content">
                                       <div class="row">
                                          ...
                                          <div class="col-lg-2-5 p-l-0">
                                             ...
                                             <a class="btn btn-shadow btn-rounded btn-iconed btn-block m-t-10">SHOP NOW!</a>
                                             <small class="t300">
            ...
            <div class="container">
               ...
               <div class="row mb-3">
                  ...
                  <div class="col-lg-6 text-right">
                     ...
                     <div id="export_buttons" class="mt-2">
                        <div class="dt-buttons btn-group">          <button class="btn buttons-print btn-light" tabindex="0" aria-controls="datatable" type="button"><span>Print</span></button> <button class="btn buttons-pdf buttons-html5 btn-light" tabindex="0" aria-controls="datatable" type="button"><span>PDF</span></button> <button class="btn buttons-excel buttons-html5 btn-light" tabindex="0" aria-controls="datatable" type="button"><span>Excel</span></button> <button class="btn buttons-csv buttons-html5 btn-light" tabindex="0" aria-controls="datatable" type="button"><span>CSV</span></button> <button class="btn buttons-copy buttons-html5 btn-light" tabindex="0" aria-controls="datatable" type="button"><span>Copy</span></button> </div>
                     </div>
                  </div>
               </div>
               <div class="row">
                        ...
                        <div class="row">
                           <div class="col-sm-12">
                              <table id="datatable" class="table table-bordered table-hover dataTable" style="width: 100%;" role="grid" aria-describedby="datatable_info">
                                 <thead>
                                    <tr role="row">
                                       <th class="sorting_asc" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 96px;">Sıra No</th>
                                       <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 154px;">Kimlik No</th>
                                       <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="width: 67px;">Kurum Sicil No</th>
                                       <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Age: activate to sort column ascending" style="width: 29px;">Medeni Hali</th>
                                       <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Date: activate to sort column ascending" style="width: 48px;">Cep Tel</th>
                                       <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Salary: activate to sort column ascending" style="width: 45px;">Görev Unvanı</th>
                                       <th class="noExport sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Actions: activate to sort column ascending" style="width: 53px;">Actions</th>
                                    </tr>
                                 </thead>
                                 <tbody>
                                 @foreach ($personelBilgi as $personel)
                                 <tr role="row" class="odd">
                                       <td class="sorting_1">{{$personel->sira_no}}</td>
                                       <td>{{$personel->kimlik_no}}</td>
                                       <td>{{$personel->kurum_sicil_no}}</td>
                                       <td>{{$personel->medeni_hali}}</td>
                                       <td>{{$personel->cep_tel}}</td>
                                       <td>{{$personel->gorev_unvani}}</td>
                                       <td>
                                          <a class="ml-2" href="{{route('personel-duzenle-ekran',$personel->id)}}" data-toggle="tooltip" data-original-title="Edit"><i class="icon-edit"></i></a>
